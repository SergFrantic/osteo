        ...
        <div className={styles.body_second_level_container}>
          ...
          <div className={styles.right_container}>
            <p>
              ...
              где единственные инструменты - специалист, его знания, опыт и
              руки. В остеопатии применяется тотальное слушание тела, тканей и
              ...
              напряжение не только в каждом органе, но и в нашей голове, и
              вернуть здоровье каждой клеточке организма.
            </p>
          </div>
        </div>
      </div>
